module.exports = function () {
    ...
    async function request(url, data = {}, flags = {}) {
        ...
        const userAgent = 'Mozilla/4.0 (compatible; Xchange Node API)';
    ...
    return {
        ...
        openOrders: async function (symbol = false) {
            ...
            return await request('/v1/openOrders', parameters, { type: 'SIGNED' });
        },

        balance: async function () {
            return request('/v1/account', {}, { type: 'SIGNED' });
        }
    }
}();
